...
public class OculusFingerController : MonoBehaviour
{
    ...
    void SetupFingerType(FingerType type)
    {
        ...
        switch (fingerType)
        {
            case FingerType.L_Thumb:
                ...
                axis = new Vector3(-0.1f, -1.5f, 0.9f);
                isThumb = true;
                break;
        ...
        if (jointLevelPool.Count >= 3)
        {
            ...
            float[,] levels = {
                { 0.05f, 0.5f, 0.9f },  // 親指
                { 0.9f - 0.1f, 1.0f - 0.2f, 1.2f - 0.3f },   // 人差し指
                { 1.0f - 0.1f, 0.8f - 0.2f, 1.6f - 0.3f },   // 中指
                { 1.0f - 0.1f, 0.7f - 0.2f, 1.6f - 0.3f },   // 薬指
                { 1.0f - 0.1f, 0.7f - 0.2f, 1.6f - 0.3f }    // 小指
            };
